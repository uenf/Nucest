...
describe AreasHelper do
  ...
  it "retornar o conteúdo do ítem da lista de áreas" do
    ...
    # area = FactoryGirl.create :area, :nome => 'area', :id => 1, :instituicao_ids => [ instituicao.id ]
    ...
    # area = FactoryGirl.create :area, :nome => 'area2', :id => 2
  ...
  it "gerar lista de áreas" do
    pending
    # instituicao = FactoryGirl.create :instituicao
    # a = FactoryGirl.create :area, :nome => 'a', :id => 1, :instituicao_ids => [ instituicao.id ]
    # b = FactoryGirl.create :area, :nome => 'b', :id => 2
    # c = FactoryGirl.create :area, :nome => 'c', :father_id => a.id, :id => 3
    # d = FactoryGirl.create :area, :nome => 'd', :father_id => a.id, :id => 4
    # e = FactoryGirl.create :area, :nome => 'e', :father_id => c.id, :id => 5
